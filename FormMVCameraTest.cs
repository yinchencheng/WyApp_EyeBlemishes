...
namespace WY_App
{
    public partial class FormMVCameraTest : Form
    {
        ...
        private Int32 NecessaryOperBeforeGrab()
        {
            ...
            if (Convert.ToUInt16( MyCamera.MvGvspPixelType.PixelType_Gvsp_Undefined) == stPixelFormat.nCurValue)
            {
